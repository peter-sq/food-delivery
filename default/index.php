...
<!-- Mirrored from coderthemes.com/minton/layouts/default/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Dec 2020 15:55:04 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Log In </title>
                            ...
                            <div class="card-body p-4">
                                ...
                                <?php include('./functions/errors.php'); ?>
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-danger btn-block" type="submit" name="login_user"> Log In </button>
                                    </div>
