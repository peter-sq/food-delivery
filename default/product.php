<?php 
require(__DIR__ .'../functions/process.php');
if(isset($_POST['submit'])){
 $validation = new productValidate($_POST);
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title"><i class="far fa-gem"></i> Products</h4>
                        ...
                        <div class="card" style="width: 50rem;padding: 1.5rem;margin-left: 8rem;">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <a href="#"><h4 class="header-title"><i class="fas fa-plus-circle"></i> Add a Products</h4></a>
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                    ...
                                    <div class="form-group col-md-6 py-sm-2 ">
                                      <input type="text" class="form-control" id="Product" placeholder="Product details" name="product">
                                      <div class="error"></div>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="image-upload">
                                        <label id="Upload" for="file-input">
                                            <a id ="fileupload">
                                                <i class="fas fa-plus fa-3x circle-icon"aria-hidden="true" ></i>
                                            </a>
                                        </label>
                                      
                                        <input id="file-input" type="file" id="image" name="image" style="display:none" />
                                        <div class="error"></div>
                                        <?php echo $errors['image'] ?? '' ?>
                                      </div>
                                    </div>
                                  
                                    <p>Each picture should not exceed 5mb<br>supported format are *Jpg, *png, *gif</p>
                                    
                                    <button type="submit" class="btn btn-danger" style = "width: 50%;margin-left: 9rem;" value="submit" name="submit">submit</button>
                                  </form>
                            </div>
                          </div>
                            </div> <!-- end col -->
